...
window.initializeMobileNavigation=function(){document.querySelectorAll('#primary-navigation a').forEach(a=>{if(a.dataset.mobileBound)return;a.dataset.mobileBound='1';a.addEventListener('click',()=>setMenu(false));});};
